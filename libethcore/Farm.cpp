...
void Farm::submitProof_frk(Solution const& _s) {
    g_io_service.post(m_io_strand.wrap(boost::bind(&Farm::submitProofAsync_frk, this, _s)));
}

void Farm::submitProofAsync_frk(Solution const& _s) {

  Result r = EthashAux::eval_frk(_s.work.header, _s.nonce);
